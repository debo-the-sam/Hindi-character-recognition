...
from tensorflow.keras.layers import Input, Dense, Activation, ZeroPadding2D, BatchNormalization, Flatten, Conv2D, AveragePooling2D, MaxPooling2D, Dropout, GlobalMaxPooling2D, GlobalAveragePooling2D
...
class DevnagiriCNN:
    def ___init___(self):
        ...
        self.classes = None
        self.ckpt = None
        print("DevnagiriCNN Model initialized")
    ...
    def train(self,X,Y,epochs = 5,test_size = 0.3,batch_size = 10,model_save = False):
        ...
        print('\nValidation Results: val_loss {}  val_acc {}'.format(val_loss,val_acc))
        ...
        if(model_save == True):
            ...
            try:
                ...
                print("\nModel saved at {}".format(model_save))
            except Exception as e:
                print("Error in filename or path given for saving model....")
                self.model.save(model_path)
                print("\nModel saved at {}".format(model_path))
        else:
            pass
    ...
    def validate(self,X,Y):
        ...
        # print('\nValidation Results on new Test data : val_loss {}  val_acc: {}'.format(val_loss,val_acc))
        ...
        for i in range(10):
            ...
            print("\nExpected output: {}    Prediction: {}     Expected class: {}".format(expected_output,val_prediction,expected_corresponding_class))
    ...
    def loadModel(self,height,width,channels,classes,path):
        ...
        self.classes = classes
        self.model = tf.keras.models.load_model(path)
        print("Loaded pre-trained model at path: {}".format(path))